...
def clean_occupancy_mask(mask: np.ndarray, kernel_size: int = 3, min_size: int = 300) -> tuple[np.ndarray, int, np.ndarray, np.ndarray]:
    """
...
def process_image(image: np.ndarray, reference_empty: np.ndarray, 
                  scale_factor: int = 4, min_size: int = 300, crop_size = (360, 360), crop_center=(275, 200)) -> Tuple[np.ndarray, int, np.ndarray, np.ndarray]:
    """
